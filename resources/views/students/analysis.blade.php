        ...
        @if($paper)
            ...
            @else
                <div class="col-lg-6 col-md-12">
                    <div class="mb-4">
                        <h4 class="m-0">System Analysis</h4>
                        <p style="opacity: .8;">Submit your System Analysis details</p>
                    </div>
                    <form action="/students/system-analysis" method="post" class="d-flex flex-column gap-4 pb-5" enctype="multipart/form-data">
                        @csrf
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/students/system-analysis/{{ $paper->id }}" method="post" class="d-flex flex-column gap-4 pb-3" enctype="multipart/form-data">
                            @csrf
