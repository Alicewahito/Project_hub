        ...
        @if($paper)
                ...
                <div class="d-flex flex-column gap-4 pb-5">
                    ...
                    <div class="d-flex justify-content-between gap-5 align-items-center">
                        <div class="form-group d-flex gap-3 align-items-center w-100">
                            <label for="" class="" style="font-weight: 400;">Document:</label>
                            <a href="/{{ $paper->file }}" class="text-decoration-underline" target="_blank">Documentation</a> 
                        </div>
                        <div class="form-group d-flex gap-3 align-items-center w-100">
                            <label for="" class="" style="font-weight: 400;">Github Link:</label>
                            <a href="/{{ $paper->file }}" class="text-decoration-underline" target="_blank">{{ $paper->github_repo }}</a> 
                        </div>
                    </div>
                ...
                @if($paper->status !== 'Pending')
                    <div class="">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control custom-input" rows="10" readonly></textarea>
                        </div>
            ...
            @else
                <div class="col-lg-6 col-md-12">
                    <div class="mb-4">
                        <h4 class="m-0">System Implementation</h4>
                        <p style="opacity: .8;">Submit your System Implementation details</p>
                    </div>
                    <form action="/students/implementation" method="post" class="d-flex flex-column gap-4 pb-5" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="" class="mb-3" style="font-weight: 400;">Github Repo Link</label>
                            <input type="text" name="github" class="form-control" placeholder="https://github.com/username/repo" required />
                        </div>
                        <div class="form-group">
                            <label for="" class="mb-3" style="font-weight: 400;">Documentation</label>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/students/implementation/{{ $paper->id }}" method="post" class="d-flex flex-column gap-4 pb-3" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="" class="mb-3" style="font-weight: 400;">Github Repo Link</label>
                                <input type="text" name="github" class="form-control custom-input" value="{{ $paper->github_repo }}" required />
                            </div>
